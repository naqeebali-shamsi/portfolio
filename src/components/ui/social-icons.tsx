...
import { socialMediaLinks } from "../../assets/data/portfolio"

const socials = [
  {
    name: "GitHub",
    href: socialMediaLinks.github || "https://github.com",
    icon: (
  ...
  {
    name: "X",
    href: socialMediaLinks.twitter || "https://x.com",
    icon: (
      <svg viewBox="0 0 24 24" fill="currentColor" className="size-[18px]">
  ...
  {
    name: "LinkedIn",
    href: socialMediaLinks.linkedin || "https://linkedin.com",
    icon: (
      <svg viewBox="0 0 24 24" fill="currentColor" className="size-[18px]">
  ...
  {
    name: "Dribbble",
    href: socialMediaLinks.dribbble || "https://dribbble.com",
    icon: (
      <svg viewBox="0 0 24 24" fill="currentColor" className="size-[18px]">
